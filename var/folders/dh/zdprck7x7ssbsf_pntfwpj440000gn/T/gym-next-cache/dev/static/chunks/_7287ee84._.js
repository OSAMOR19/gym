...
function AuthProvider({ children }) {
    ...
    const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[login]": async (email, password)=>{
            ...
            const found = users.find({
                "AuthProvider.useCallback[login].found": (u)=>u.email === email.toLowerCase() && u.passwordHash === hash
            }["AuthProvider.useCallback[login].found"]);
            if (!found) {
                return {
    ...
    const signup = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[signup]": async (name, email, password)=>{
            ...
            if (users.some({
                "AuthProvider.useCallback[signup]": (u)=>u.email === lowerEmail
    ...
    const resetPassword = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[resetPassword]": async (email)=>{
            const users = getUsers();
            const found = users.find({
                "AuthProvider.useCallback[resetPassword].found": (u)=>u.email === email.toLowerCase()
            }["AuthProvider.useCallback[resetPassword].found"]);
            if (!found) {
                return {
            ...
            saveUsers(users);
            return {
                message: 'Password has been reset to "password123". Please login and change it.'
            };
        }
...
_s(AuthProvider, "Tb1FDBe+d1iZESR0U7JTcnvla2A=");
_c = AuthProvider;
function useAuth() {
    _s1();
...
//# sourceMappingURL=_7287ee84._.js.map