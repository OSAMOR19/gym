...
const ACCENT: Record<ToastType, { border: string; bg: string; bar: string }> = {
    success: { border: 'rgba(34,197,94,0.25)',  bg: 'rgba(34,197,94,0.06)',  bar: '#22c55e' },
    error:   { border: 'rgba(239,68,68,0.25)',  bg: 'rgba(239,68,68,0.06)',  bar: '#ef4444' },
    warning: { border: 'rgba(245,158,11,0.25)', bg: 'rgba(245,158,11,0.06)', bar: '#f59e0b' },
    info:    { border: 'rgba(56,189,248,0.25)', bg: 'rgba(56,189,248,0.06)', bar: '#38bdf8' },
};
    ...
    return (
        ...
        >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
                ...
                {toast.message && (
                    <p style={{ margin: '3px 0 0', fontSize: '12px', color: 'rgba(255,255,255,0.4)', lineHeight: '1.4' }}>
                        {toast.message}
                    </p>
                )}
            </div>
